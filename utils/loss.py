...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        # tcls:包含了gt中的类
        # tbox:对应的box
        # indices:image_id,gt匹配到的anchors_id，grid_j,grid_i
        # anchors:对应上述anchor_id的anchors尺寸
    ...
    def build_targets(self, p, targets):
        ...
        行数等于target数量,shape is [target[0].shape, 1]
        '''
        ...
        for i in range(self.nl):
            ...
            # Define
            bc, gxy, gwh, a = t.chunk(4, 1)  # (image_id, class), grid xy, grid wh, anchors
            a, (b, c) = a.long().view(-1), bc.long().T  # anchors, image, class
            gij = (gxy - offsets).long()
            gi, gj = gij.T  # grid indices

            # Append
            indices.append((b, a, gj.clamp_(0, shape[2] - 1), gi.clamp_(0, shape[3] - 1)))  # imag_id, anchor, grid
